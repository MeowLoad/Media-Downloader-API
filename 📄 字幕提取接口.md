...
> [!IMPORTANT]
> 本文是**老版本接口**（无版本号 `/openapi/…`）的文档，仅供已接入的开发者查阅。新接入请使用 v1 接口文档：<https://docs.henghengmao.com/developer/video-subtitle-downloader-api>；迁移指南：<https://docs.henghengmao.com/developer/migration>。
>
> This page documents the **legacy (unversioned) API** and is kept for developers who already integrated it. For new integrations use the v1 API docs: <https://docs.henghengmao.com/en/developer/video-subtitle-downloader-api>; migration guide: <https://docs.henghengmao.com/en/developer/migration>.
